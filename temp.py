...
output_path = '/home/sarashs/Python-forcefield-optimizer/tests/Zr_Si_forcefield/'
geofilecreator(Input_structure_file, output_path)
a = SA_REAX_FF(ff_filePath, output_path, ParamSelect_filePath, Training_file, Input_structure_file, T=1, T_min=0.01, Temperature_decreasing_factor=0.1, max_iter=10, number_of_points=5, min_style = 'cg')
...
#geofilecreator(Input_structure_file, output_path)
#a = SA_REAX_FF(ff_filePath, output_path, ParamSelect_filePath, Training_file, Input_structure_file, T=1000, T_min=10, Temperature_decreasing_factor=0.1, max_iter=30, number_of_points=1, min_style = 'cg')
