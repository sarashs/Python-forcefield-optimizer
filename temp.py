...
a = SA_REAX_FF(ff_filePath, output_path, ParamSelect_filePath, Training_file, Input_structure_file, T=10, T_min=1, Temperature_decreasing_factor=0.1, max_iter=10, number_of_points=1)
...
#import os
#for file_name in os.listdir("/home/sarashs/Python-forcefield-optimizer/tests/Zr_Si_forcefield/equilibriums/"):
#    if file_name.endswith(".xyz"):
#        append_2structure_file("/home/sarashs/Python-forcefield-optimizer/tests/Zr_Si_forcefield/equilibriums/", "/home/sarashs/Python-forcefield-optimizer/tests/", file_name, "Zr_O_Si_structure", box_dim = [100, 100, 100])
...
#        gaussian_energy_extractor("/home/sarashs/Python-forcefield-optimizer/tests/Zr_Si_forcefield/equilibriums/", "/home/sarashs/Python-forcefield-optimizer/tests/", file_name, "gaussian_energies")
