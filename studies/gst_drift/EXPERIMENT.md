...
- `ecutwfc = 40` Ry (orbital cutoff; bump to 50 for production)
- `ecutrho = 320` Ry (= 8 × ecutwfc, SSSP recommendation)
- `kpts = [1, 1, 1]` (Γ-only — fine for the 18-atom supercell;
  bump to `[2,2,2]` for tighter elastic-constant fits)
