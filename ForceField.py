...
class REAX_FF(ForceField):
    ...
    def write_forcefield(self,Out_ff_filePath,params=None):
        ...
        temp_file.write("This force field was generated by Pyfield optimization tool developed by Ivanov-SOC at UBC\n")
    ...
    def parseParamSelectionFile(self):
        ...
        for i in range(self._param_selected):
            # to take care of commenting
            if '#' not in self.Param_read[i][0]:
